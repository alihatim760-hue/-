    ...
    if (error) {
      setError(
        error.includes('already registered')
          ? 'هذا البريد مسجل مسبقاً. سجل الدخول بدلاً من ذلك.'
          : error
      );
    } else {
      navigate('/dashboard');
    ...
    <div className="flex min-h-screen items-center justify-center bg-navy-900 px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-card rounded-2xl p-8">
          <h1 className="font-serif text-2xl font-semibold text-cream-100">إنشاء حساب جديد</h1>
          <p className="mt-2 text-sm text-cream-300/60">أنشئ حسابك لطلب الدعوات ومتابعتها</p>
